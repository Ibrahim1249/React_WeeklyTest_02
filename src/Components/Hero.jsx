...
function Hero() {
  return (
    <>
      <div className="hero-container md:px-8 px-0 py-16 bg-[#0E182C] flex items-center justify-center gap-12 2xl:w-4/6 xl:w-[75%] w-[100%] mx-auto">
        <div className="w-2/4 text-[#F3F4F6]">
